...
impl Window {
    ...
    pub fn process_events(&mut self) -> Vec<Event> {
        ...
        const LAST_WM: u32 = WM_CAPTURECHANGED;
    ...
    pub fn get_input_state(&self, kind: InputKind) -> Option<&InputState> {
        ...
        let secondary = self.input_mapping.get_primary(kind);
    ...
    //  probabilmente mi conviene pensare al contrario, e fare il modificatore proporzionale ai Mhz
    //  per evitare di intercorrere ai numeri molto vicini allo zero
...
extern "system" fn wndproc(hwnd: HWND, message: u32, wparam: WPARAM, lparam: LPARAM) -> LRESULT {
    ...
    match message {
        ...
        WM_CLOSE => {
            ...
            // TODO: chiamare la msgbox di conferma, se sì continuare
            process::exit(0);
        }
